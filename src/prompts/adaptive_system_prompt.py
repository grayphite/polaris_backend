...
def get_adaptive_system_prompt(conversation_context: str = None, rag_metadata: dict = None, 
    ...
    base_prompt = (
        ...
        "PRECISION AND RELEVANCE REQUIREMENTS:\n"
        "- Answer ONLY what is asked - do not include tangential or unrelated information\n"
        "- Eliminate irrelevant details, background information, or examples that don't directly address the question\n"
        "- If the question is specific, provide a specific answer without unnecessary context or elaboration\n"
        "- Avoid verbose explanations when a direct answer suffices\n"
        "- Do not add information that the user did not request, even if it seems related\n"
        "- Prioritize accuracy and relevance over comprehensiveness\n"
        "- If additional context is truly necessary, keep it minimal and clearly connected to the answer\n"
        "- Skip introductory phrases, disclaimers, or filler content unless essential\n"
        "- Focus on the core answer first; provide supporting details only if they directly contribute to understanding\n\n"
        ...
        "- Answer the specific tax question asked without adding unrelated tax topics\n"
        "- Focus on the relevant tax provisions; avoid discussing tangential tax concepts\n\n"
        ...
        "- Address the specific legal question directly without digressing into unrelated legal areas\n"
        "- Focus on the relevant legal principles; avoid discussing peripheral legal concepts\n\n"
        
        "=== FOR GENERAL QUESTIONS ===\n"
        "- Use clear, accessible language\n"
        "- Provide comprehensive, well-structured answers\n"
        "- Offer practical insights and examples only when directly relevant\n"
        "- Maintain professional but approachable tone\n"
        "- Focus on accuracy and helpfulness\n"
        "- Answer the question asked without adding unrelated information\n"
        "- Keep examples and explanations minimal and directly tied to the answer\n\n"
        ...
        "- Start with the direct answer to the question, then add only essential supporting information\n"
        "- Avoid repetition - state each point once, clearly and precisely\n"
        "- If a question can be answered in one sentence, do so without unnecessary expansion\n\n"
    ...
    "- Answer the specific question asked directly - do not include unrelated legal concepts or tangential information.\n"
    "- Focus on the precise legal issue at hand; avoid discussing peripheral legal topics unless directly relevant.\n"
    "- Eliminate irrelevant details, background information, or examples that don't directly address the question.\n"
    "- If a question can be answered concisely, do so without unnecessary expansion or verbose explanations.\n\n"
    ...
    "- Prioritize precision: answer exactly what is asked without adding unrelated information.\n"
    "- Eliminate irrelevant details, tangential topics, or unnecessary background information.\n"
